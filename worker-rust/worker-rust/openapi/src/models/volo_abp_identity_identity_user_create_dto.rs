...
pub struct VoloAbpIdentityIdentityUserCreateDto {
...
impl VoloAbpIdentityIdentityUserCreateDto {
    pub fn new(user_name: String, email: String, password: String) -> VoloAbpIdentityIdentityUserCreateDto {
