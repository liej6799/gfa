...
pub struct GfaWebConfigsCreateUpdateConfigDto {
...
impl GfaWebConfigsCreateUpdateConfigDto {
    pub fn new() -> GfaWebConfigsCreateUpdateConfigDto {
        GfaWebConfigsCreateUpdateConfigDto {
            id: None,
            creation_time: None,
            creator_id: None,
