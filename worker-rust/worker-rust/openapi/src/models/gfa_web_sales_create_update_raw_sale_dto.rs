...
pub struct GfaWebSalesCreateUpdateRawSaleDto {
    ...
    #[serde(rename = "totalChange", skip_serializing_if = "Option::is_none")]
    pub total_change: Option<f64>,
}

impl GfaWebSalesCreateUpdateRawSaleDto {
    pub fn new() -> GfaWebSalesCreateUpdateRawSaleDto {
        GfaWebSalesCreateUpdateRawSaleDto {
            id: None,
            creation_time: None,
            creator_id: None,
