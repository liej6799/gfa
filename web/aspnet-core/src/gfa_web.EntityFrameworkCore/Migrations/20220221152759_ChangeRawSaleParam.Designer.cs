...
namespace gfa_web.Migrations
{
    ...
    [Migration("20220221152759_ChangeRawSaleParam")]
    partial class ChangeRawSaleParam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gfa_web.Configs.Config", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Items.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Purchases.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Purchases.PurchaseItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Sales.RawSale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Sales.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Sales.SaleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Vendors.Vendor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("gfa_web.Purchases.Purchase", b =>
                {
                    b.HasOne("gfa_web.Vendors.Vendor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("gfa_web.Sales.SaleItem", b =>
                {
                    ...
                    b.HasOne("gfa_web.Sales.Sale", null)
                        .WithMany()
